...
Private Sub ActiveReport_DataInitialize()
    ...
    Fields.Add "NationalityAbbreviation"
    Fields.Add "DOB"
...
Private Sub ActiveReport_FetchData(EOF As Boolean)
    ...
    With ShipsRouteReport
        ...
        Fields("NationalityAbbreviation") = .grdShipsRouteReport.CellText(lngRow, "NationalityAbbreviation")
        Fields("DOB") = .grdShipsRouteReport.CellText(lngRow, "DOB")
        ...
        Fields("Phone") = .grdShipsRouteReport.CellValue(lngRow, "Phone")
...
Private Sub ReportFooter_Format()
    ...
    NationalitiesGroup.text = ShipsRouteReport.lblNationalitiesGroup.Caption
