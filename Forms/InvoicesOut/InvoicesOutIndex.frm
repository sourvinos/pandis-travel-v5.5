...
Private Sub cmdIndex_Click(Index As Integer)
    ...
    Select Case Index
        ...
        Case 4
            'Transfers
            Set tmpRecordset = CheckForMatch("CommonDB", "YesOrNo", "YesOrNoDescription", "String", txtYesOrNoDescription.text)
            If tmpRecordset.RecordCount > 0 Then
...
Private Sub txtYesOrNoDescription_Change()
...
Private Sub txtYesOrNoDescription_KeyDown(KeyCode As Integer, Shift As Integer)
...
Private Sub txtYesOrNoDescription_Validate(Cancel As Boolean)
