...
Private Sub Form_Activate()
    ...
    If Me.Tag = "True" Then
        Me.Tag = "False"
        AddColumnsToGrid grdShipsOccupants, False, 25, GetSetting(strApplicationName, "Layout Strings", "grdShipsOccupants"), "04LNID,40LNName", "ID,Περιγραφή"
        Me.Refresh
        PopulateGrid
    End If

    'AddDummyLines grdShipsOccupants, "99999", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAΑΑΑΑΑΑΑΑΑΑ"
