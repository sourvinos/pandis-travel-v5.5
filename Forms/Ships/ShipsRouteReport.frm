...
Begin VB.Form ShipsRouteReport 
   ...
   Begin VB.Frame frmContainer 
      ...
      End
      Begin VB.Label lblNationalitiesGroup 
         AutoSize        =   -1  'True
         BackColor       =   &H000080FF&
         BackStyle       =   0  'Transparent
         Caption         =   "NationalitiesGroup"
         BeginProperty Font 
            Name            =   "Ubuntu Condensed"
            Size            =   12
            Charset         =   161
...
Private Function CreateNationalityGroups()
    ...
    'Κυρίως διαδικασία
    strSQL = "SELECT NationalityAbbreviation, NationalityDescription " _
        & "FROM Nationalities " _
        & "INNER JOIN Manifest " _
        & "ON Nationalities.NationalityID = Manifest.TripNationalityID "
    ...
    'Ταξινόμηση
    strOrder = " GROUP BY NationalityAbbreviation, NationalityDescription"
    ...
    While Not rstRecordset.EOF
        lngRow = lngRow + 1
        strAll = strAll & rstRecordset.Fields(0) & " = " & rstRecordset.Fields(1) & Chr(13)
        rstRecordset.MoveNext
    Wend
    
    CreateNationalityGroups = strAll
...
Private Sub Form_Activate()
    ...
    'AddDummyLines grdShipsRouteReport, "99999", "999", "A99/99/9999Α", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "1AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "2AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA", "ΙΔΙΟΤΗΤΑΑΑΑΑΑΑΑΑΑΑΑΑ", "ΦΥΛΟΑΑΑΑΑΑΑΑΑΑΑΑΑΑΑΑ", "ΗΛΙΚΙΑΑΑΑΑΑΑΑΑΑΑΑΑΑΑ", "A99/99/9999Α", "ΗΛΙΚΙΑΑΑΑΑΑΑΑΑΑΑΑΑΑΑ"
